...
% Ensure that your functions - computeCost and gradientDescent already work with starter code and support multiple variables.
%
...
% The following code computes the closed form solution for linear regression using the normal equations.(normalEqn.m)
% After doing so, predict the price of a 1650 sq-ft, 3 br house.
%% Load Data
